...
def final_model(input_dim, filters, kernel_size, conv_stride,
    ...
    conv_1d = Conv1D(filters, kernel_size, 
                     ...
                     activation='relu',
                     name='conv1d')(input_data)
    # Add batch normalization to conv layer
    ...
    for i in range(0, recur_layers):
        bi_rnn = Bidirectional(GRU(units, return_sequences=True,
				   implementation=2, 
                                   name="bi_rnn"+str(i+1)))(bn_rnn)
        # Add batch normalization to bidirectional rnn layer
        bi_bn_rnn = BatchNormalization(name="bi_bn_rnn"+str(i+1))(bi_rnn)
        #Add dropout to avoid overfitting
        bn_rnn = Dropout(0.2)(bi_bn_rnn)
