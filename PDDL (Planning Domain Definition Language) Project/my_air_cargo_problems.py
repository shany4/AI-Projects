    ...
    def actions(self, state: str) -> list:
        ...
        for action in self.actions_list:
            ...
            for clause in action.precond_pos:
                if clause not in ds_pos:
                    is_possible = False
                    break # No need to keep searching

            # Check if action is valid in negative preconditions
...
def air_cargo_p2() -> AirCargoProblem:
    ...
    # Where are the cargo and planes
    pos = [expr('At(C1, SFO)'),
           expr('At(C2, JFK)'),
           expr('At(C3, ATL)'),
           expr('At(P1, SFO)'),
    ...
    # Where are no the cargo and planes
    # While cargo hasn't been loaded in the planes yet
    neg = [expr('At(C1, ATL)'),
           expr('At(C1, JFK)'),
           expr('At(C2, ATL)'),
           expr('At(C2, SFO)'),
